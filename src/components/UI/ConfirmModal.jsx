        ...
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-3">
              <div
                className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${isDestructive ? "bg-red-100" : "bg-blue-100"}`}
              >
                <MdWarning
                  className={`text-xl ${isDestructive ? "text-red-600" : "text-blue-600"}`}
                />
              </div>
